...
//
// class MockTestingRepository extends Mock implements TestingRepository {}
//
// void main() {
//   late MockTestingRepository mockRepository;
//   late LoginBloc loginBloc;
//
//   setUp(() {
//     mockRepository = MockTestingRepository();
//
//     // Crea instancias de LoginBloc con el mock.
...
//       build: () {
//         // Configura el mock para retornar un resultado exitoso.
//         when(mockRepository.login(any)).thenAnswer(
//               (_) async => Right(LoginResponse(token: 'mock-token')),
//         );
//         return loginBloc;
//       },
